...
```bash
cd C:/Users/maurits.visser/Mendix/Macnica-TestRunOS-main/extraction

# Phase 2: full extraction (60 seconds on the full Macnica project)
node run.js 2 xml
...
- Gaps are made explicit (266 in the Macnica project) → confidence is honest, not hidden
