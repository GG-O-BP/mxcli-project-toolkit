...
Used across all mxcli-powered projects — OS migration, HMCL, future Java/Angular migrations, and others.
...
mxcli-project-toolkit/
  ...
  bug-logs/
    ...
    bug-log-macnica-m0022.md    ← Project-specific bug log (Macnica M-0022)
  process/
    process-learnings.md        ← Cross-project process improvements
    test-plan-macnica-m0022.md  ← Reference test plan
