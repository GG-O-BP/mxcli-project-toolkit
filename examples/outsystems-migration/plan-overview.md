...
| 4 | Integration strategy: stub or live for POC? | Stub all external integrations (SAP, uSoner) via boolean constants — swap at Phase 1 |
...
CONST_STUB_uSoner = true → Corporation search returns a hardcoded result
```
