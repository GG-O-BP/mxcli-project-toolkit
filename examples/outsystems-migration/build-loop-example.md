...
| IsBelongMacnicaGroup | Boolean | Conditional visibility rule | Checkbox |
...
script: 06-act-microflows.mdl
  ...
  - ACT_SNP_CorpSearch_Execute — executes corporation search (STUB_uSoner branch)
...
| Sec4: IsBelongMacnicaGroup | Checkbox | ✅ |
