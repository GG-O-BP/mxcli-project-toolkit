...
- Mendix app running at `http://localhost:8080` (logged in or loginable as yoko.taoka / Macnica12345)
...
```bash
./mxcli -p Macnica-TestRunOS.mpr -c "DESCRIBE PAGE PayerRegistration.PayerRegistration_Overview" > tests/ux-page-struct-overview.txt
./mxcli -p Macnica-TestRunOS.mpr -c "DESCRIBE PAGE PayerRegistration.Payer_OrgChoice" > tests/ux-page-struct-orgchoice.txt
./mxcli -p Macnica-TestRunOS.mpr -c "DESCRIBE PAGE PayerRegistration.Payer_Confirm_Selection" > tests/ux-page-struct-confirmation.txt
./mxcli -p Macnica-TestRunOS.mpr -c "DESCRIBE PAGE PayerRegistration.PayerDetail_NewEdit" > tests/ux-page-struct-newedit.txt
./mxcli -p Macnica-TestRunOS.mpr -c "DESCRIBE NAVIGATION Responsive" > tests/ux-page-struct-navigation.txt
./mxcli -p Macnica-TestRunOS.mpr -c "SHOW SNIPPETS IN PayerRegistration" > tests/ux-page-struct-snippets.txt
```
