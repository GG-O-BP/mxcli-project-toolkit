...
- [/source-triage](./source-triage.md) - Checks this assessment's findings against this toolkit's actual extractor/mapper coverage, decides which extraction pipeline to reuse or build (extraction always runs, regardless of app size), and recommends a bounded scope before any BRD is generated
