...
**Source:** Macnica M-0022 — 9 KB files produced across 4 sessions, 2026-05.
...
Examples:
  ...
  KB_uSoner_API.md                  ← external API manuals (combined)
...
Based on the Macnica KB files. Adapt sections to what the source contains.
...
|-------|-----------|------|-----------|-------|
| PayerCode | 支払コード | Text(10) | Yes | Auto-generated |
...
|--------|--------|-----------|-----------|
| uSoner | Corporate search | CID, keyword | Yes — return hardcoded result |
