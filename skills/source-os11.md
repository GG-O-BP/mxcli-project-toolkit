...
**Source:** Macnica M-0022 — 114 eSpace XML files, 2026-05.
...
<ESpace
  ...
  Description="支払人・請求先登録"        ← often Japanese
...
| MetaSystems employee sync | Scheduled microflow + External DB or REST |
| uSoner corporate search | REST client (`CompanySearchResult` NPE as response DTO) |
