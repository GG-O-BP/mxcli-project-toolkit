...
**Source:** Macnica M-0022 — 114 real eSpace XML files processed 2026-05.

---

## What an eSpace XML file is

Each `.xml` file in an Omnext blueprint delivery is one OutSystems **eSpace** —
...
<ESpace
  Version="11"
  Key="ESpace:6EeWoOOi90KxAL7U5mhhbg"     ← GUID with type prefix
  Name="M0022_PayerRegist"                  ← module name (= file name without .xml)
  Description="支払人・請求先登録"           ← Japanese description is common
...
```xml
<StaticEntity Name="ENApplyCategory" Description="申請区分">
  <Attributes>
  ...
  <StaticRecords>
    <StaticRecord Name="NewRegistration">
      <StaticRecordAttributeValues>
        <StaticRecordAttributeValue AttributeName="Label" Value="新規登録" />
        <StaticRecordAttributeValue AttributeName="Order" Value="1" />
      </StaticRecordAttributeValues>
    </StaticRecord>
    <StaticRecord Name="Expansion">
      <StaticRecordAttributeValues>
        <StaticRecordAttributeValue AttributeName="Label" Value="口座追加" />
      </StaticRecordAttributeValues>
    </StaticRecord>
  </StaticRecords>
</StaticEntity>
...
```xml
<WebBlock Name="SNP_CorpSearch" Description="企業検索スニペット">
  <InputParameters>
...
```xml
<Roles>
  <Role Name="HQDomestic" Description="国内本社" IsPersistent="Yes" />
  <Role Name="SysAdmin"   Description="システム管理者" IsPersistent="Yes" />
</Roles>
```
...
```xml
<Timer Name="JOB_SapSync" Description="SAP同期" Schedule="0 2 * * *">
...
## Common naming conventions in Macnica OS code
