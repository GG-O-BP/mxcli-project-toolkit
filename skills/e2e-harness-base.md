...
**Source:** Macnica M-0022 — 5 test suites built 2026-05, helpers.js pattern.
...
- Test user credentials known (e.g. `yoko.taoka / Macnica12345`)
...
(async () => {
  ...
  await page.fill('#passwordInput', 'Macnica12345');
...
const TEST_PASS = process.env.TEST_PASS || 'Macnica12345';
